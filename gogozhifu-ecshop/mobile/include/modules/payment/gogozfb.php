...
$payment_lang = ROOT_PATH . 'lang/' . $GLOBALS['_CFG']['lang'] . '/payment/gogozfb.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    $modules[$i]['config'] = array(
        array('name' => 'gogozfb_appid', 'type' => 'text', 'value' => ''),
        array('name' => 'gogozfb_appsecret', 'type' => 'text', 'value' => ''),
    );
...
class gogozfb
{
    ...
    function get_code($order, $payment)
    {
        ...
        $appId = $payment['gogozfb_appid']; // APPID
        $appSecret = $payment['gogozfb_appsecret']; // APPSECRET
        // GOGO支付创建订单API地址
