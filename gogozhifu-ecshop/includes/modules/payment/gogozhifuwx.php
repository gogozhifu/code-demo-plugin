...
$payment_lang = ROOT_PATH . 'languages/' . $GLOBALS['_CFG']['lang'] . '/payment/gogozhifuwx.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 代码 */
    $modules[$i]['code'] = "gogozhifuwx";

    /* 描述对应的语言项 */
    $modules[$i]['desc'] = 'gogozhifuwx_desc';
    ...
    $modules[$i]['config'] = array(
        array('name' => 'gogozhifuwx_appid', 'type' => 'text', 'value' => ''),
        array('name' => 'gogozhifuwx_appsecret', 'type' => 'text', 'value' => ''),
    );
    return;
}
...
class gogozhifuwx
{
    ...
    function get_code($order, $payment)
    {
        ...
        $appId = $this->payment['gogozhifuwx_appid']; // APPID
        $appSecret = $this->payment['gogozhifuwx_appsecret']; // APPSECRET
...
//        $price = 2.88;
    ...
    function logResult($word = '', $var = array())
    {
        ...
        file_put_contents($log_path . "gogozhifuwx.txt", $output, FILE_APPEND | LOCK_EX);
    }
