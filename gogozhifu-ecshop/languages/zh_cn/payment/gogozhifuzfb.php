...
$_LANG['gogozhifuzfb'] = 'GOGO支付-支付宝';
$_LANG['gogozhifuzfb_desc'] = '当前是GOGO支付的支付宝插件。GOGO支付 - 更好的个人支付解决方案。 免费注册使用、个人免签约、无手续费、免挂机、实时回调。';
$_LANG['gogozhifuzfb_appid'] = '应用ID(AppID)';
$_LANG['gogozhifuzfb_appsecret'] = '应用密钥(AppSecret)';
$_LANG['gogozhifuzfb_button'] = '立即用GOGO支付';
